...
We already covered the basics about functions in [basic syntax]({{site.url}}chapters/basic_syntax/#function-definitions).
...
Type hints can prevent many of the [issues caused by PHP's type system]({{site.url}}chapters/type_juggling) introduced in the previous chapter.
